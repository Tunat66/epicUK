...
export DETECTOR_PATH=/home/pemb7000/eic/epic/install/share/epic
...
if [[ "$(uname -s)" = "Darwin" ]] || [[ "$OSTYPE" == "darwin"* ]]; then
        export DYLD_LIBRARY_PATH="/home/pemb7000/eic/epic/install/lib${DYLD_LIBRARY_PATH:+:$DYLD_LIBRARY_PATH}"
else
        export LD_LIBRARY_PATH="/home/pemb7000/eic/epic/install/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"
fi
